static inline __u8 optlen(const __u8 *opt, __u8 offset){
 ...
 */
static inline __u64 __get_tcp_option(__u8 *ippacket, __u8 tcpoptnum){
	struct iphdr *iph;
	struct tcphdr *tcph;
	__u64 tcpoptdata;
 ...
 */
static inline int __set_tcp_option(__u8 *ippacket, unsigned int tcpoptnum,
